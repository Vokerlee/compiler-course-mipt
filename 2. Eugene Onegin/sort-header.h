#ifndef SORT-HEADER_H_INCLUDED
#define SORT-HEADER_H_INCLUDED
...
void bred_generator (line_t *lines, FILE *res, int n);


#endif // SORT-HEADER_H_INCLUDED
